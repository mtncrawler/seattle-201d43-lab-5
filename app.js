...
function sumArray(sumArr) { //eslint-disable-line
  return[sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0], (sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0], sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0] + ' is their sum.')];
}
